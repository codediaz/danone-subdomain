      ...
      <div className="max-w-5xl mx-auto px-10 py-10 bg-white rounded-lg shadow-xl">
        {!formSubmitted ? (
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4">¡Correo enviado!</h2>
            <p className="text-gray-700">Gracias por enviar tu formulario. Hemos recibido tu información.</p>
            <button
              type="button"
              className="inline-block mt-4 px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
